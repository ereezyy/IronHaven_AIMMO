        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center justify-center mb-12">
            ...
            <p className="text-gray-400 text-sm text-center max-w-xl mb-8">
              Ironhaven is a brutal, immersive journey into the criminal
              underworld where your choices shape the narrative. Prepare for a
              dark, uncompromising story that challenges your moral compass.
            </p>
              ...
              {!isSubmitted ? (
                <>
                  ...
                  <p className="text-gray-400 text-sm mb-6 text-center">
                    Be the first to receive updates, exclusive content, and beta
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 flex items-start">
                      ...
                      >
                        I confirm that I am at least 17 years old and I agree to
                        receive emails about Ironhaven and related offers.
                      </label>
                    </div>
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-gray-400 text-sm">
                    We've added you to our waitlist. Watch your inbox for
                    updates on Ironhaven.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0 flex items-center">
                ...
                <span className="text-gray-400 text-xs">
                  Mature 17+ | Violence | Strong Language | Drug Use
                </span>
              </div>

              <div className="text-gray-500 text-xs">
                &copy; {new Date().getFullYear()} Ironhaven. All rights
                reserved.
              </div>
            </div>
          </div>
