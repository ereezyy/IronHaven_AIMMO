        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Ironhaven offers a raw, visceral experience that pushes the
              boundaries of emotional storytelling in gaming.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-2/3 p-6 md:p-8">
                ...
                <p className="text-gray-300 mb-6 text-sm md:text-base">
                  Ironhaven doesn't pull its punches. This is no sanitized crime
                  fantasy—it's a brutal look at the psychological toll of
                  violence and the cycle of poverty and crime. The story
                  confronts players with the ugly reality behind the power
                  fantasy, creating emotional resonance through unflinching
