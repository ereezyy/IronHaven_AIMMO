        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="w-full md:w-1/2 order-2 md:order-1">
                ...
                <p className="text-gray-300 mb-6 text-sm md:text-base leading-relaxed">
                  Danny, a 19-year-old from Ironhaven's crumbling slums, has
                  nothing but his wits and determination. Born into poverty and
                  raised in violence, he's forced to navigate a world where
                  loyalty is temporary and betrayal is inevitable.
                </p>
                <p className="text-gray-300 mb-6 text-sm md:text-base leading-relaxed">
                  Working for the feared Falcone crime family, Danny's hands
                  quickly become stained with blood. Each job pulls him deeper
                  into a web of corruption that spans from street corners to the
                  highest offices in Ironhaven.
                </p>
                <p className="text-gray-400 text-sm italic">
                  "In Ironhaven, you either become the predator or remain the
                  prey. There is no middle ground."
                </p>
              </div>
          ...
          <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-sm">
            ...
            <p className="text-gray-300 text-sm md:text-base">
              Every decision in Ironhaven carries weight. Show mercy to a rival?
              They might return the favor—or exploit your weakness. Execute a
              traitor? You'll send a message, but create new enemies. Your
              choices shape Danny's journey and determine which of multiple
