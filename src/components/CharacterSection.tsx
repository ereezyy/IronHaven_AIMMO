  ...
  return (
    <section className="bg-zinc-900 py-20 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://images.pexels.com/photos/9754/mountains-clouds-forest-fog.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)',
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center mb-16">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-gray-300 mb-6 text-sm md:text-base leading-relaxed">
                Danny grew up in the projects of Ironhaven with nothing but a
                desperate hunger to escape poverty. Smart, resourceful, but
                hardened by a life of violence, he's caught between his ambition
                and the last fragments of his conscience.
              </p>
              <p className="text-gray-300 mb-6 text-sm md:text-base leading-relaxed">
                As you guide Danny through Ironhaven's criminal underworld,
                you'll shape not just his skills, but his character. Every
                mission, every kill, and every betrayal pulls him deeper into
                darkness - or offers a chance at redemption.
              </p>

              <div className="bg-red-600/10 border border-red-800/30 p-4 rounded-sm">
                <p className="text-gray-200 text-sm italic">
                  "I started out thinking I could control this life, use it to
                  get what I needed. Now I'm starting to think this life is
                  using me. The question is: how far am I willing to go?"
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <ProgressionCard
              ...
              levels={[
                ...
                {
                  name: 'Local Muscle',
                  description: 'Respected in your neighborhood',
                },
                {
                  name: 'Made Man',
                  description: 'Recognized lieutenant in the family',
                },
                {
                  name: 'Legendary',
                  description: 'Your name strikes fear citywide',
                },
              ]}
            />
            <ProgressionCard
              ...
              levels={[
                ...
                {
                  name: 'Enforcer',
                  description: 'Skilled with basic firearms',
                },
            ...
            <ProgressionCard
              ...
              levels={[
                {
                  name: 'Corner Boy',
                  description: 'Small-time street operations',
                },
                {
                  name: 'Local Boss',
                  description: 'Control neighborhood rackets',
                },
                {
                  name: 'District Captain',
                  description: 'Run major territory operations',
                },
            ...
            <ProgressionCard
              ...
              levels={[
                ...
                {
                  name: 'Cold-Blooded',
                  description: 'Ruthless and calculating',
                },
      ...
      <div className="space-y-2">
        {levels.map((level, index) => (
          <div key={index} className="flex gap-2">
            <div
              className={`w-2 h-2 rounded-full mt-1.5 ${index === 0 ? 'bg-red-500' : 'bg-zinc-600'}`}
            ></div>
            <div>
