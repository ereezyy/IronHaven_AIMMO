...
export class WorldGenerator {
  ...
  generateDialogueForBiome(
    ...
    const dialogues = {
      downtown: {
        civilian: [
          "This city's getting worse every day.",
          'I just want to get home safe.',
          'Too many criminals around here.',
        ],
        police: [
          'Keep it moving, citizen.',
          "This area's under patrol.",
      ...
      residential: {
        civilian: [
          ...
          "Kids can't even play outside anymore.",
        ],
        dealer: [
          'Quiet around here, good for business.',
          "Family man's gotta eat.",
          'Keep it low-key.',
        ],
        police: [
          "Patrol's been doubled.",
    ...
    if (
      biomeDialogues &&
      biomeDialogues[npcType as keyof typeof biomeDialogues]
    ) {
  ...
  async updateWorld(
    ...
    const { chunkX: playerChunkX, chunkZ: playerChunkZ } = this.getChunkCoords(
      playerPosition[0],
      playerPosition[2]
    );
